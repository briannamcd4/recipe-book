...
const SUPABASE_SERVICE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFzdWhncHRraXNrYmFzdXJ0emlrIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NTY3ODAzNywiZXhwIjoyMDkxMjU0MDM3fQ.Kd_N_uzNL1eKPtbGkpcGGZSUSZIR-P2O15Afmky-Eck';
...
async function fetchAndSave() {
  ...
  try {
    ...
    status.className = 'url-status error';
    status.textContent = 'Could not auto-fetch. Try adding the recipe manually instead.';
  } finally {
    btn.disabled = false;
  }
}
